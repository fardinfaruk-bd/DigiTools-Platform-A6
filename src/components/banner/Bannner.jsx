    ...
    <div>
      <div className="hero bg-white-200 min-h-screen w-[85%] mx-auto">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          />
          <div>
            <div className="badge border-none bg-[#E1E7FF] mb-4 ">
              <div className="p-0.5 bg-linear-to-r from-[#4f39f61d] to-[#9614fa28] rounded-full flex justify-center items-center">

                <div className="p-0.5 bg-linear-to-r from-[#4f39f672] to-[#9614fa63] rounded-full flex justify-center items-center">
                  <div className="w-1.5 h-1.5 bg-linear-to-r from-[#4f39f6] to-[#9614fa] rounded-full">
                  </div>
                </div>
