...
const Banner = () => {
  return (
    <div>
      <div className="hero bg-white-200 py-10 md:py-20 w-[95%] md:w-[90%] lg:w-[85%] mx-auto">
        <div className="hero-content flex-col gap-20 md:gap-20 lg:gap-4  lg:flex-row-reverse">
          ...
          <div>
            ...
            <div className="badge border-none bg-[#E1E7FF] mb-4 py-4 flex justify-center md:justify-start">
            ...
            <h1 className="text-5xl md:text-7xl text-[#101727] font-extrabold">Supercharge Your Digital Workflow</h1>
