    ...
    return (
        <div className="w-full bg-linear-to-r from-[#4F39F6] to-[#9514FA] p-15">
            <div className="w-[60%] mx-auto">
                <div className="space-y-20 md:space-y-15 lg:space-y-0 lg:flex lg:gap-10 justify-between">
                    ...
                    <div className=" md:w-20 w-0.5 md:h-0.5 h-20 md:mx-auto  bg-gray-400 opacity-80 hidden md:block"></div>
